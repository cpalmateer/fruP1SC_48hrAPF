...
#Supplemental Figure 3A and 3C
#Supplemental Figure 4C and 4D (cluster key for heatmaps)
```{r}
...
#Sex-biased cluster annotation based on Supplemental Table 3
```{r}
...
DimPlot(object = Merge, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red"))
```
...
#Supplemetnal Figure 7A, Supplemental Table 3
...
DimPlot(object = RandomCellRemoval1, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red"))
```
...
DimPlot(object = RandomCellRemoval2, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red"))
```
...
DimPlot(object = RandomCellRemoval3, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red"))
```
...
```{r}
p1<-DimPlot(object = Merge, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red")) & NoAxes()
p2<-DimPlot(object = RandomCellRemoval1, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red")) & NoAxes()
p3<-DimPlot(object = RandomCellRemoval2, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red")) & NoAxes()
p4<-DimPlot(object = RandomCellRemoval3, reduction = "umap",cols = c("light blue", "grey", "purple", "light pink", "dark blue", "blue", "red")) & NoAxes()
plot_grid(p1, p2, p3, p4, ncol=4)
```

Downsampling analysis where female cells were downsampled to equal male cell number and fully reanalyzed
#Supplemental Figure 7B, Supplemental Table 3
...
#Read in sex-bias annotations in Supplemental Table 3
...
DimPlot(object = Merge.downsampled1, reduction = "umap",cols = c("light blue", "grey", "light pink", "dark blue", "blue", "purple", "red"))
```
...
DimPlot(object = Merge.downsampled2, reduction = "umap",cols = c("light blue", "grey", "light pink", "purple", "dark blue", "blue"))
```
...
DimPlot(object = Merge.downsampled3, reduction = "umap",cols = c("light blue", "grey", "light pink", "dark blue", "blue", "purple", "red"))
```
...
```
#Supplemental Figure20A
```{r}
HTFdotplot<-DotPlot(Merge, features = Hmarkergenes)
HTFdotplot+ theme(axis.text.x = element_text(angle = 90, hjust=1))   
```

#Supplemental Figure20B
```{r}
HTFdotplot<-DotPlot(Merge, features = Hmarkergenes, split.by = "sex", cols=c("#00BFC4", "#F8766D"))
HTFdotplot+ theme(axis.text.x = element_text(angle = 90, hjust=1))   
```
...
#Supplemental Figure 21A
```{r}
CTFdotplot<-DotPlot(Merge, features = Cmarkergenes)
CTFdotplot+ theme(axis.text.x = element_text(angle = 90, hjust=1))   
```
#Supplemental Figure 21B
```{r}
CTFdotplot<-DotPlot(Merge, features = Cmarkergenes, split.by = "sex", cols=c("#00BFC4", "#F8766D"))
CTFdotplot+ theme(axis.text.x = element_text(angle = 90, hjust=1))   
```
...
```{r}
HTHdotplot<-DotPlot(Merge, features = HTHmarkergenes, split.by = "sex", cols=c("#00BFC4", "#F8766D"))
HTHdotplot+ theme(axis.text.x = element_text(angle = 90, hjust=1))   
```
